...
contract MasterVampire is Ownable, Timelock {
    ...
    // we don't need the VampireAdapter or Victim class for testing
...
//              " ` "
    ...
    // start rewards right away for testing
    //uint256 public constant REWARD_START_BLOCK = 11008888; // Wed Oct 07 2020 13:28:00 UTC
    uint256 public constant REWARD_START_BLOCK = 0;
    ...
    constructor(
        ...
        weth = IERC20(address(0));
        drcWethPair = _drcWethPair;
    }
    ...
    // we don't need the VampireAdapter or Victim class for testing
    function add(address _victim, uint256 _victimPoolId, uint256 _rewardPerBlock, uint256 _rewardDrainModifier, uint256 _wethDrainModifier) public onlyOwner {
    ...
    function pendingDrc(uint256 _pid, address _user) external view returns (uint256) {
        ...
        uint256 lpSupply = drcWethPair.balanceOf(address(this));
    ...
    // only testing pid 0
    function drain(uint256 _pid) public pure {
